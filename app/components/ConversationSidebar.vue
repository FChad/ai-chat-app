<template>
  <div class="flex flex-col h-full bg-background text-foreground">
    ...
    <div class="border-b border-border p-4 sm:px-6 flex items-center">
      <UButton @click="startNewConversationHandler" class="w-full">
    ...
    <div class="flex-1 overflow-y-auto p-3 scrollbar-thin">
      <div class="space-y-2">
        ...
        <div v-else-if="chatStore.conversations.length === 0" class="text-center text-muted-foreground mt-12">
          <UCard class="mx-4">
            <UCardContent class="p-4 text-center">
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center space-x-2 mt-2">
                  <UBadge variant="secondary" class="text-xs max-w-full overflow-hidden">
              ...
              <UTooltip side="left">
                <template #trigger>
                  <button
                    class="opacity-0 group-hover:opacity-100 ml-2 shrink-0 h-8 w-8 inline-flex items-center justify-center rounded-md text-destructive hover:bg-destructive/10 transition-all"
