<template>
  <div class="mobile-sidebar sm:w-80 lg:w-80 bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border-r border-gray-200/30 dark:border-gray-700/30 flex flex-col h-full fixed lg:relative left-0 top-0 mobile-transition shadow-xl lg:shadow-none" :class="{ 'open': isMobileOpen }">
    <!-- Mobile Close Button -->
